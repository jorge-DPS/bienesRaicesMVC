...
<fieldset>
    ...
    <textarea id="descripcion" name="propiedad[descripcion]" type="text"><?php echo sanitizar($propiedad->descripcion); ?></textarea>
</fieldset>
...
<fieldset>
    ...
    <input type="number" id="wc" name="propiedad[wc]" placeholder="Ej: 3" value="<?php echo sanitizar($propiedad->wc); ?>">

    <label for="estacionamiento">Estacionamiento:</label>
    <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ej: 3" value="<?php echo sanitizar($propiedad->estacionamiento); ?>">
